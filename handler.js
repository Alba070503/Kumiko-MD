...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || 'Kumiko-MD By @Alba070503') :
(chat.sBye || this.bye || conn.bye || 'Bye, @user!')).replace('@user', '@' + user.split('@')[0])
			    
if (chat.antifake && isBotAdminNn && action === 'add') {
const numerosPermitidos = ["1", "2", "4", "6", "7", "8", "9"] //PUEDES EDITAR LOS USUARIOS QUE SE ELIMINARÃN SI EMPIEZA POR CUALQUIER DE ESOS NÃšMEROS	
...
"thumbnail": apii.data, 
"title": [wm, '🗿' + gt + ' By @Alba070503', 'Sigueme en YT como @Alba070503'].getRandom(),
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: 'NamiBot-MD', thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaAN15BJP21BYCJ3tH04'}}}}, aa);
